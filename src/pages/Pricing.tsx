...
import { pricingRows, subscriptionTiers, pricingPhilosophy } from '../data/studio';
      ...
      <section className="relative py-16 lg:py-20 border-b border-ink-700/40">
        <div className="mx-auto max-w-edge px-5 lg:px-8">
          ...
          <Reveal delay={1} className="mt-10">
            <div className="overflow-hidden rounded-2xl border border-ink-700/50">
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-ink-700/50 bg-ink-900/60">
                    ...
                    <th className="py-4 px-5 lg:px-7 text-[11px] uppercase tracking-[0.24em] text-bone-400 font-medium hidden sm:table-cell">What it is</th>
                    <th className="py-4 px-5 lg:px-7 text-[11px] uppercase tracking-[0.24em] text-bone-400 font-medium text-right">Investment</th>
                  </tr>
                </thead>
                <tbody>
                  {pricingRows.map((row, i) => (
                    ...
                    >
                      ...
                      <td className="py-5 px-5 lg:px-7 text-sm text-bone-400 hidden sm:table-cell">{row.whatItIs}</td>
                      <td className="py-5 px-5 lg:px-7 text-right">
                        <span
                          className={`text-sm font-medium ${
                            row.investment === 'Subscription' ? 'text-ember-400' : 'text-bone-200'
                          }`}
                        >
                          {row.investment}
                        </span>
